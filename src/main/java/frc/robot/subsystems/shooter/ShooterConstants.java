...
public class ShooterConstants {
  ...
  public static final double intakeLauncherMotorReduction =
      1.0; // reduction of speed of intake motor
  public static final int intakeLauncherCurrentLimit =
      60; // limit of what the intake motor can run in RPM

  public static final double intakingFeederVoltage =
      -12.0; // feeder roller voltage when intake command takes place
  ...
  public static final double launchingLauncherVoltage =
      8.8; // changed to fit right speed of motor. default was 10.6 and value where we want it is
  // 9.5
  public static final double spinUpFeederVoltage =
      -6.0; // flywheel voltage when shooting command takes place
  public static final double spinUpSeconds =
      1.0; // seconds it takes for the flywheel to spin once command begins
}
